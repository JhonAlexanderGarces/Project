            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-success">
                        ...
                        <div class="icon">
                            <i class="fas" ><i class="bi bi-bar-chart-fill"></i></i></i>
                        </div>
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-default">
                        ...
                        <div class="icon">
                            <i class="fas" ><i class="bi bi-person-fill-gear"></i></i></i>
                        </div>
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-dark">
                        ...
                        <div class="icon">
                            <i class="fas" style="color: white;"><i class="bi bi-person-raised-hand"></i></i></i>
                        </div>
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-primary">
                        ...
                        <div class="icon">
                            <i class="fas" style="color: white;"><i class="bi bi-person-arms-up"></i></i></i>
                        </div>
