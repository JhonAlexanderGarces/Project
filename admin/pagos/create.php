                                ...
                                <tr>
                                    ...
                                    <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                ...
                                                <a type="button" data-toggle="modal" data-target="#Modal_editar<?=$id_pago;?>" type="button" class="btn btn-success btn-sm"><i class="bi bi-pencil"></i></a>

                                                <div class="modal fade" id="Modal_editar<?=$id_pago;?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header" style="background-color:rgb(30, 230, 12)">
