...
// INSERTAR EN LA TABLA PPFF
$sentencia = $pdo->prepare('INSERT INTO ppffs
       (estudiante_id,nombres_apellidos_ppff,ci_ppff,celular_ppff,ocupacion_ppff,ref_nombre,ref_parentezco,ref_celular,estado)
VALUES (:estudiante_id,:nombres_apellidos_ppff,:ci_ppff,:celular_ppff,:ocupacion_ppff,:ref_nombre,:ref_parentezco,:ref_celular,:estado)');
...
if ($sentencia->execute()) {
    $pdo->commit();
    $_SESSION['mensaje'] = "Se registró al estudiante correctamente.";
