...
if ($sentencia->execute()) {
    echo 'success';
    $pdo->commit();
    $_SESSION['mensaje'] = "Se actualizó el personal administrativo correctamente.";
    $_SESSION['icono'] = "success";
    header('Location:' . APP_URL . "/admin/administrativos");
} else {
    echo 'error al registrar en la base de datos';
    $pdo->rollBack();
    $_SESSION['mensaje'] = "Error: no se pudo actualizar la base de datos. Contacte al administrador.";
